const events = [
  ...
  {id:"openai-astra-critical-cyber",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["policy","ai"],label:"机制 / 政策更新",date:"09.01",title:"OpenAI 将 Astra 评定为关键级网络安全能力模型",summary:"OpenAI 称尚未正式发布的 Astra 已达到其 Preparedness Framework 的关键级网络安全能力阈值，是首个被如此评定的模型；公司称已延后部分训练与发布工作，并将高级网络安全能力先限于测试者和防御性使用渠道。",importance:97,evidence:"A",confidence:"OpenAI 官方安全公告；能力评测、风险阈值与缓解有效性均为公司披露，Astra 尚未正式上线",source:"OpenAI",url:"https://openai.com/index/path-to-astra/",why:"这是前沿实验室首次将模型公开归入最高网络风险能力档，并把训练基础设施、模型行为和上线权限放到同一套发布门槛下。",next:"关注 Astra 的正式发布日期、系统卡、独立红队结果，以及 Daybreak Blue 的准入与审计安排。"},
