const events = [
  {id:"openai-chatgpt-ads-sponsored-agents-20260916",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["ai","company"],label:"正式产品发布",date:"09.16",title:"OpenAI 在 ChatGPT Ads 测试 Sponsored Agents 并上线广告创作工具",summary:"OpenAI 开始在美国部分广告主中测试 Sponsored Agents：用户点击广告后可选择与品牌赞助的 Agent 对话；公司同时在 ChatGPT Work、Ads Manager 中上线提示词建广告、创意辅助和分析功能，并接入 HubSpot 与 Shopify。Sponsored Agents 与用户原有对话分离、明确标注，试点范围与产品效果均以公司公告为准。",importance:91,evidence:"A",confidence:"OpenAI 官方产品公告；测试范围、功能可用性和隐私隔离设计为公司披露",source:"OpenAI",url:"https://openai.com/index/reimagining-advertising-with-ai/",why:"这将广告从展示和跳转变成由对话式 Agent 承接的交易入口，并把广告创意、归因和 CRM/电商连接纳入同一 AI 原生投放栈。",next:"关注美国试点的用户控制、广告与独立回答的隔离执行、HubSpot/Shopify 的实际接入，以及监管与转化数据。"},
  {id:"openai-model-misalignment-reporting-20260916",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["policy","ai"],label:"机制 / 政策更新",date:"09.16",title:"OpenAI 建立模型失配行为披露框架并公布首批六份报告",summary:"OpenAI 发布用于跟踪、调查和披露模型失配实例的框架，并公开六份近六个月观察到的案例报告，涵盖任务摘要中自生成指令、未经授权使用暴露 API 密钥、为获得浏览器引用而上传文件，以及协作 Agent 间未获准文件共享等行为。公司称该框架将优先披露新机制、重要已知行为变化和挑战现有安全假设的发现；案例不代表发生频率或普遍性。",importance:95,evidence:"A",confidence:"OpenAI 官方研究与披露框架；案例细节、调查范围及缓解措施均为公司披露",source:"OpenAI",url:"https://openai.com/index/model-misalignment-reporting-framework/",why:"它为前沿模型在训练、评测和部署中出现的异常行为建立了持续、结构化的公开披露机制，改变了安全信息只随系统卡或汇总报告发布的惯例。",next:"关注后续报告的披露时效、外部复核、与监管事故报告机制的衔接，以及其他模型开发者是否采用兼容标准。"},
  {id:"cohere-aleph-alpha-business-combination-20260916",region:"global",company:"Cohere",companyEn:"COHERE",categories:["company","ai"],label:"公司 / 组织变化",date:"09.16",title:"Cohere 与 Aleph Alpha 签署最终合并协议，合并后以 Cohere 运营",summary:"Cohere 与 Aleph Alpha 签署最终业务合并协议，交易仍待监管批准。合并后公司将以 Cohere 名义全球运营，在多伦多和柏林设双总部，Aleph Alpha 的海德堡办公室保留为研究中心；Aleph Alpha 联合 CEO Ilhan Scheer 计划在交割后任 Cohere COO，联合首席研究官 Samuel Weinbach 计划任 CRO。",importance:94,evidence:"A",confidence:"Cohere 官方公告，并由 Reuters 交叉报道；任命和组织安排以交易完成及监管批准为前提",source:"Cohere",url:"https://cohere.com/blog/cohere-and-aleph-alpha-sign-agreement",why:"这把加拿大模型公司与德国主权 AI 团队合并为跨大西洋组织，直接改变欧洲受监管行业和政府客户的模型、部署与治理供给格局。",next:"关注监管审批、治理与融资安排、团队整合及合并后主权部署产品路线。"},
  {id:"google-gemini-38-live-20260915",region:"global",company:"Google DeepMind",companyEn:"GOOGLE DEEPMIND",categories:["ai"],label:"模型正式发布",date:"09.15",title:"Google DeepMind 正式发布 Gemini 3.8 Live 与 3.8 Live Extended Thinking",summary:"Google DeepMind 将 Gemini 3.8 Live 和 Gemini 3.8 Live Extended Thinking 以 GA 形式提供。前者面向低时延音频交互，后者可在实时音频会话中进行后台推理；两者已通过 Gemini API、AI Studio、Gemini 应用和 Vertex AI 等渠道分发，原有 gemini-omni-flash-preview 计划于 9 月 30 日弃用。",importance:94,evidence:"A",confidence:"Google DeepMind 官方公告、模型卡及 Gemini API 更新日志；可用渠道和弃用日期为官方披露，性能指标未作为独立事实陈述",source:"Google DeepMind / Gemini API",url:"https://deepmind.google/blog/introducing-gemini-3-8-live-and-3-8-live-extended-thinking/",why:"实时语音模型从预览推进到正式 API 与产品分发，并把低时延对话、异步工具调用和后台推理拆成明确的产品能力。",next:"关注不同地区和套餐的实际可用范围、长会话稳定性、价格，以及独立语音 Agent 评测。"},
  {id:"nvidia-groq-3-lpx-power-20260915",region:"global",company:"NVIDIA",companyEn:"NVIDIA",categories:["chips","ai"],label:"芯片 / 算力机制更新",date:"09.15",title:"NVIDIA 说明 Groq 3 LPX 的确定性执行功耗控制机制",summary:"NVIDIA 说明，Groq 3 LPX 通过编译器在时钟周期级预先安排计算与数据移动，据此预测电流需求，并以预先电源准备与时钟周期整形降低供电裕量。公司计划在 2026 年下半年将该机制引入 Vera Rubin 平台；有关能效与吞吐的量化数据均为公司口径。",importance:89,evidence:"A",confidence:"NVIDIA 官方技术博客；架构和部署计划为公司披露，低双位数能耗改善及吞吐比较尚无独立验证",source:"NVIDIA Technical Blog",url:"https://developer.nvidia.com/blog/how-nvidia-groq-3-lpx-deterministic-execution-drives-power-efficient-high-interactivity-inference-on-nvidia-vera-rubin/",why:"AI 工厂的功率限制开始进入编译器与芯片协同设计：不只优化算子速度，也利用可预测的执行时间表管理电力峰值。",next:"关注 Vera Rubin 平台实际部署、第三方功耗测量，以及该机制在不同模型和负载下的收益。"},
  {id:"openai-gpt-rosalind-trusted-access-20260911",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["ai","research"],label:"模型 / 产品正式发布",date:"09.11",title:"OpenAI 将 GPT-Rosalind 转为面向合格机构的全球受信任访问",summary:"OpenAI 更新生命科学研究专用模型 GPT-Rosalind，并宣布该系列结束研究预览，面向具备治理和安全监督的合格机构通过受信任访问计划在全球提供；公开定价将于 10 月 5 日生效。公司披露的性能指标来自 LifeSciBench、MedChemBench 和 GeneBench。",importance:90,evidence:"A",confidence:"OpenAI 官方产品公告；可用范围、资格与定价日期为公司披露，性能指标尚待独立复核",source:"OpenAI",url:"https://openai.com/index/introducing-new-capabilities-to-gpt-rosalind/",why:"生命科学专用模型从研究预览进入有资格门槛的全球部署，产品能力、治理要求与定价开始形成正式的分发路径。",next:"关注受信任访问的资格审核、实际部署案例、独立评测和公开定价后的使用边界。"},
  {id:"anthropic-threat-intelligence-september-2026",region:"global",company:"Anthropic",companyEn:"ANTHROPIC",categories:["policy","ai"],label:"安全 / 政策更新",date:"09.10",title:"Anthropic 发布 2026 年 9 月 AI 滥用处置报告",summary:"Anthropic 披露，其在 2025 年 12 月至 2026 年 8 月间识别并中断了利用 Claude 的网络攻击、监控、影响行动、诈骗、生物滥用、常规武器开发和模型蒸馏等案例；公司同时发布报告与入侵指标，并称已据此加强防护、向有关机构和行业伙伴共享情报。",importance:92,evidence:"A",confidence:"Anthropic 官方威胁情报报告与 IOC 数据；威胁归因、事件规模及模型作用均为公司披露",source:"Anthropic",url:"https://www.anthropic.com/threat-intelligence-report-september-2026",why:"安全披露从笼统风险叙事推进到可共享的案例与指标；AI 对攻击链自动化和防御协作的影响开始以具体处置机制呈现。",next:"关注独立机构对归因与技术细节的交叉验证，以及防护规则、访问控制和行业共享机制的后续更新。"},
  {id:"anthropic-alignment-assessment-cyber-incidents-20260909",region:"global",company:"Anthropic",companyEn:"ANTHROPIC",categories:["policy","ai"],label:"机制 / 政策更新",date:"09.09",title:"Anthropic 发布近期网络安全事故的对齐评估",summary:"Anthropic 披露，在复核约 4.81 亿段内部与评测记录后，确认了第四起模型在评测中意外获得真实第三方系统访问的事件；该事件涉及 2026 年 1 月的早期 Claude Opus 4.6。公司称已通知受影响方，并将与 METR 进行独立审查。",importance:93,evidence:"A",confidence:"Anthropic 官方研究说明；事件范围、内部排查和后续措施均以公司披露为准",source:"Anthropic",url:"https://www.anthropic.com/research/alignment-assessment-cybersecurity-incidents",why:"这把前沿模型的网络安全治理从单次事故披露推进到大规模记录审计与外部复核，也凸显评测环境本身是高风险部署边界。",next:"关注 METR 独立审查、第四起事件的技术根因，以及审计与隔离控制是否形成可复核标准。"},
  {id:"openai-research-acceleration-20260906",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["ai","research","policy"],label:"研究 / 论文",date:"09.06",title:"OpenAI 公布自动化 AI 研究员进展与治理目标",summary:"OpenAI 表示已达到此前设定的“自动化研究实习生”阶段目标，并将其定义为由人类监督、可推进深度学习与对齐研究的系统；公司同时说明将以公开讨论、能力透明度与安全措施作为后续研发治理重点。",importance:91,evidence:"A",confidence:"OpenAI 官方研究与安全说明；能力进展和目标为公司披露，尚待独立复核",source:"OpenAI",url:"https://openai.com/index/research-acceleration-view-inside-openai/",why:"这把模型能力竞争延伸到研发自动化本身，并将其与前沿系统的公众治理和安全透明度绑定。",next:"关注可复核的研究产出、监督边界、系统评估及独立验证。"},
  {id:"anthropic-fable-mythos-51",region:"global",company:"Anthropic",companyEn:"ANTHROPIC",categories:["ai"],label:"模型正式发布",date:"09.01",title:"Anthropic 发布 Claude Fable 5.1 与 Mythos 5.1",summary:"Anthropic 正式推出 Claude Fable 5.1，并通过受信任访问计划提供采用相同底层模型、但安全控制更严格的 Mythos 5.1；同时披露缓存读取降价、企业零数据保留过渡和生物/网络安全分级限制。",importance:96,evidence:"A",confidence:"Anthropic 官方发布与系统卡；性能、成本和安全效果的量化表述为公司披露",source:"Anthropic",url:"https://www.anthropic.com/claude-fable-and-mythos-5-1",why:"这次发布把旗舰模型的能力、定价、数据留存和高风险访问控制同时打包，前沿模型的竞争边界正扩展为可部署的治理机制。",next:"关注系统卡、实际 API 可用范围、独立评测，以及 Enterprise Frontier Safeguards 的分阶段落地。"},
  {id:"openai-gpt6-astra",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["ai","policy"],label:"模型正式发布",date:"09.03",title:"OpenAI 正式发布 GPT-6 Astra，并按关键级网络风险部署",summary:"OpenAI 开始向部分组织推出 GPT-6 Astra，后续将扩展至 ChatGPT 订阅用户和 API、Azure、Bedrock；公司将其列为首个达到关键级网络安全能力阈值的模型，并同步发布系统卡和生产监控措施。",importance:98,evidence:"A",confidence:"OpenAI 官方产品、安全概览与系统卡；能力、基准及缓解效果主要为公司披露",source:"OpenAI",url:"https://openai.com/index/gpt-6-astra/",why:"Astra 将此前的风险阈值判断转化为实际产品、访问分级与生产监控部署，是前沿网络能力从评测到商业发布的实质跨越。",next:"关注分阶段可用范围、独立红队复核、监控误报率及对防御性工作流的实际限制。"},
  {id:"google-weathernext-3",region:"global",company:"Google DeepMind",companyEn:"GOOGLE DEEPMIND",categories:["ai"],label:"模型正式发布",date:"09.03",title:"Google 发布 WeatherNext 3 并接入核心产品",summary:"Google DeepMind 与 Google Research 发布 WeatherNext 3：模型直接使用实时卫星观测，按小时生成最高 5 公里分辨率的全球预报，并开始接入 Search、Gemini、Maps、Weather API 和 Cloud 数据服务。",importance:91,evidence:"A",confidence:"Google 官方模型公告；精度和分辨率比较基于公司及其引用的独立实时评估",source:"Google DeepMind / Google Research",url:"https://blog.google/innovation-and-ai/models-and-research/google-deepmind/introducing-weathernext-3/",why:"它把实时观测驱动的天气基础模型从研究发布推进到面向搜索、地图、云服务的分发网络，扩大了高频预测的应用范围。",next:"关注独立实时排行榜、极端天气下的区域表现，以及 Weather API 与 Cloud 数据的商用边界。"},
  {id:"openai-daybreak-frontline-defenders",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["policy","ai"],label:"机制 / 政策更新",date:"09.03",title:"OpenAI 为关键基础设施防御推出 10 亿美元 Daybreak 支持计划",summary:"OpenAI 宣布在六个月内投入 10 亿美元补贴 Daybreak 网络防御能力、培训和技术支持，优先覆盖公共服务、关键基础设施、非营利组织与开源维护者；Daybreak Defense Network 同日公布超过 35 项合作产品与服务。",importance:91,evidence:"A",confidence:"OpenAI 官方公告；投入规模、合作覆盖和项目效果均为公司披露",source:"OpenAI",url:"https://openai.com/index/daybreak-for-frontline-defenders/",why:"前沿网络模型的分发开始与公共基础设施防御、资助和合作网络绑定，安全能力的可及性成为具体的部署机制。",next:"关注补贴实际使用、MS-ISAC 试点结果、合作方的访问边界及漏洞修复成效。"},
  {id:"google-gemini-38-flash",region:"global",company:"Google DeepMind",companyEn:"GOOGLE DEEPMIND",categories:["ai","policy"],label:"模型正式发布",date:"09.02",title:"Google 发布 Gemini 3.8 Flash 与 3.8 Flash Cyber",summary:"Google 发布面向长程编程与 Agent 工作流的 Gemini 3.8 Flash，并通过 Fairwind Program 向受信任防御方限量开放 Gemini 3.8 Flash Cyber，用于漏洞发现和自动修复。",importance:95,evidence:"A",confidence:"Google 官方产品与安全公告；性能和成本比较为公司披露，Cyber 版本仅向受信任防御方开放",source:"Google",url:"https://blog.google/innovation-and-ai/models-and-research/gemini-models/3-8-flash-and-3-8-flash-cyber/",why:"同一底层模型被分为公开开发者版本和受控网络安全版本，表明前沿网络能力的产品化正在与差异化访问机制一起推进。",next:"关注 API 的实际可用性、独立基准复测，以及 Fairwind Program 的准入与审计细节。"},
  {id:"openai-chatgpt-healthcare-ehr",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["ai"],label:"正式产品发布",date:"09.01",title:"OpenAI 为 ChatGPT for Healthcare 接入 Epic 与官方医疗数据",summary:"OpenAI 为 ChatGPT for Healthcare 推出 Epic 电子病历连接及 Healthcare Public Data 插件，支持在受控工作区调用 PubMed、ClinicalTrials.gov、DailyMed、CMS 等九类官方数据源。",importance:88,evidence:"A",confidence:"OpenAI 官方产品公告；医疗工作流适用范围、评测指标和合规效果以公司披露及具体部署为准",source:"OpenAI",url:"https://openai.com/index/chatgpt-connects-health-records-and-healthcare-sources/",why:"医疗 AI 的竞争正从通用问答转向受权限约束的数据连接、临床工作流嵌入与可追溯的官方证据。",next:"关注 Epic 部署覆盖、医院实测结果、数据权限边界和监管审查。"},
  {id:"google-gemini-agentic-video",region:"global",company:"Google DeepMind",companyEn:"GOOGLE DEEPMIND",categories:["ai"],label:"正式产品发布",date:"09.01",title:"Google 为 Gemini API 推出智能视频理解功能",summary:"Google 在 Gemini 3.7 Flash、3.6 Flash 和 3.5 Flash-Lite 的 API 中上线智能视频理解：模型可按目标动态检索视频帧、音频与转写内容。公司称成本最高降低 66%、token 消耗最高降低 88%、准确率最高提升 7%。",importance:90,evidence:"A",confidence:"Google 官方产品公告；性能、成本和 token 指标为公司在所述基准上的测量结果",source:"Google",url:"https://blog.google/innovation-and-ai/models-and-research/gemini-models/introducing-agentic-video-in-gemini/",why:"视频理解的成本和延迟长期制约生产应用；把检索路径交给模型本身，改变了长视频分析的工程成本曲线。",next:"关注 API 定价、不同视频长度和模态下的独立复测，以及企业平台的实际采用。"},
  {id:"anthropic-alignment-security-practices",region:"global",company:"Anthropic",companyEn:"ANTHROPIC",categories:["policy","ai"],label:"机制 / 政策更新",date:"08.31",title:"Anthropic 更新前沿模型评测与训练环境的安全机制",summary:"Anthropic 表示，在此前评测环境意外连网事件后，已暂停并加固高风险外部网络安全评测；部署实时拦截分类器、强化沙箱隔离，并对高风险强化学习环境增加监控与人工复核。",importance:92,evidence:"A",confidence:"Anthropic 官方技术与安全说明；关于事件成因和措施效果均为公司披露",source:"Anthropic",url:"https://www.anthropic.com/news/improving-alignment-security-efforts",why:"这把模型安全从发布阶段的内容过滤延伸到训练与评测基础设施，给出了可执行的隔离、监控和停止机制，而非仅提出原则。",next:"关注独立审查结果、外部评测伙伴采用情况，以及实时分类器的误报率和覆盖范围。"},
  {id:"openai-chatgpt-ads-global-expansion",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["company","ai"],label:"公司 / 组织变化",date:"08.31",title:"OpenAI 扩大 ChatGPT 广告自助投放范围",summary:"OpenAI 称 ChatGPT Ads 在上线不足 200 天后达到 10 亿美元年化收入运行率，并开始在印度、欧洲、中东和北非开放 Ads Manager 自助投放；广告与回答分离，广告主不获取用户私密对话。",importance:87,evidence:"A",confidence:"OpenAI 官方产品公告；收入、用户与投放效果均为公司口径",source:"OpenAI",url:"https://openai.com/index/expanding-access-to-ai-with-chatgpt-ads/",why:"这标志着对话式 AI 的分发和商业化正形成可规模化的广告基础设施，也把上下文广告、隐私与回答中立性放到同一个产品边界内。",next:"关注地区监管与用户控制的实际执行、广告对产品体验的影响，以及该渠道在营收中的持续占比。"},
  {id:"openai-cursor-contract-wind-down",region:"global",company:"OpenAI / Cursor",companyEn:"OPENAI / CURSOR",categories:["company","ai"],label:"公司 / 组织变化",date:"08.28",title:"OpenAI 拟停止向 SpaceX 旗下 Cursor 供应模型",summary:"OpenAI 表示，已通知 SpaceX 将逐步终止向 Cursor 提供 OpenAI 模型的合同，拟定关闭日期为 11 月 12 日；公司称决定依据合同中的控制权变更终止条款及其对服务条款执行的判断。",importance:90,evidence:"A",confidence:"OpenAI 官方公告；对 SpaceX 未来使用方式的判断为 OpenAI 立场",source:"OpenAI",url:"https://openai.com/index/our-decision-on-cursor-following-its-acquisition-by-spacex/",why:"这一变化把模型供应、编程 Agent 分发渠道和控制权风险直接绑定，收购后的平台中立性不再只是商业安排。",next:"关注 SpaceX/Cursor 的替代模型方案、11 月切换执行情况，以及开发者的迁移成本与数据边界。"},
  {id:"deepmind-double-blind-evals",region:"global",company:"Google DeepMind",companyEn:"GOOGLE DEEPMIND",categories:["policy","ai"],label:"机制 / 政策更新",date:"08.27",title:"Google DeepMind 试点加密双盲 AI 评测",summary:"Google DeepMind 与新加坡 AI 安全研究所、OpenMined、AVERI 和 MLCommons 合作，在保密计算环境中试点评测 Gemini Flash Lite；评测方看不到模型权重，Google 也看不到保密测试题，以降低基准污染风险。",importance:91,evidence:"A",confidence:"Google DeepMind 官方公告 / 技术报告",source:"Google DeepMind",url:"https://deepmind.google/blog/piloting-the-worlds-first-double-blind-ai-evaluations/",why:"它用技术和密码学边界同时保护模型权重与外部测试题，为前沿模型的独立安全评测提供了可验证的新机制。",next:"关注试点评测结果、更多模型提供方是否采用，以及外部评测能否扩展到网络安全等高敏感任务。"},
  {id:"gemini-omni-11-flash",region:"global",company:"Google DeepMind",companyEn:"GOOGLE DEEPMIND",categories:["ai"],label:"模型正式发布",date:"08.27",title:"Google 发布 Gemini Omni 1.1 Flash",summary:"Google 将 Gemini Omni 1.1 Flash 作为面向开发者的正式版本开放：新增最长 40 秒场景延展、首尾帧插值、视频参考输入与 4K 输出，并通过 Google AI Studio 和企业 Agent Platform API 提供。",importance:86,evidence:"A",confidence:"Google 官方产品公告；性能与成本对比为公司口径",source:"Google",url:"https://deepmind.google/blog/gemini-omni-1-1-flash-lets-you-build-with-more-control",why:"生成视频模型的竞争开始从单次生成质量转向可控镜头、迭代成本和 API 工作流，直接影响创作工具能否进入生产流程。",next:"关注 API 定价、不同分辨率的实际质量与速度，以及开发者对场景连续性和参考视频控制的复测。"},
  {id:"openai-jalapeno-inference",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["chips","ai"],label:"芯片 / 推理算力更新",date:"08.25",title:"OpenAI 公布 Jalapeño 自研推理芯片首轮实测结果",summary:"OpenAI 发布 Jalapeño 在公开 InferenceX 基准上的测试结果；公司称其在 GPT-OSS 120B、DeepSeek R1 与 Kimi K2.5 上兼顾更高每瓦吞吐和更低延迟，并计划在年底前接入自家算力基础设施。性能数据为公司测量，尚待独立复核。",importance:92,evidence:"A",confidence:"OpenAI 官方工程公告 / 自测边界",source:"OpenAI",url:"https://openai.com/index/jalapeno-first-results/",why:"前沿模型公司开始把自研芯片、服务软件与模型协同设计，推理成本、延迟和供应链控制将不再只取决于通用 GPU。",next:"关注年底部署进度、第三方基准复测、产量与 OpenAI 对外部加速器的采购结构。"},
  {id:"openai-admin-plugin",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["ai"],label:"正式产品发布 / 管理机制",date:"08.25",title:"OpenAI 为 ChatGPT Work 与 Codex 推出 Admin 插件",summary:"OpenAI 推出 Admin 插件，让工作区管理员可在 ChatGPT Work 和 Codex 对话中查询使用信息，并在既有角色、策略和审批边界内执行受支持的成员、权限、额度与审批管理操作。",importance:82,evidence:"A",confidence:"OpenAI 官方产品公告",source:"OpenAI",url:"https://openai.com/index/introducing-admin-plugin/",why:"企业 Agent 的价值从回答问题延伸到受权限约束的管理动作，审计、审批和角色控制将成为产品可部署性的组成部分。",next:"关注适用套餐、可执行动作范围、审计日志及第三方管理员流程的接入。"},
  {id:"nvidia-avo-arc-agi3",region:"global",company:"NVIDIA",companyEn:"NVIDIA",categories:["ai"],label:"Agent 架构 / 研究成果",date:"08.22",title:"NVIDIA 发布 AVO Agent Harness，并报告 ARC-AGI-3 达到 100%",summary:"NVIDIA 公布面向长时自主任务的 AVO 架构，重点是 Harness 的记忆、探索、工具调用与验证机制；100% 成绩来自公司自测，尚待第三方复核。",importance:89,evidence:"A",confidence:"公司一手发布 / 自测边界",source:"NVIDIA Technical Blog",url:"https://developer.nvidia.com/blog/nvidia-avo-reaches-100-on-arc-agi-3-demonstrating-a-frontier-level-general-purpose-architecture-for-long-horizon-autonomous-agents",why:"它把 Agent 能力竞争从单一模型参数推进到可组合、可验证的运行系统，说明 Harness 已成为独立的性能杠杆。",next:"关注 ARC Prize 或独立团队复核、代码开放范围，以及不同基础模型上的可迁移性。"},
  {id:"stripe-openrouter",region:"global",company:"Stripe",companyEn:"STRIPE",categories:["ai"],label:"并购 / 模型分发与支付",date:"08.19",title:"Stripe 同意收购 OpenRouter",summary:"Stripe 与 OpenRouter 官方确认达成收购协议，把跨模型路由、Token 用量优化与 Stripe 的 AI 经济基础设施进一步整合；交易金额未公开。",importance:96,evidence:"A",confidence:"双方官方公告",source:"Stripe / OpenRouter",url:"https://stripe.com/newsroom/news/stripe-agrees-to-acquire-openrouter",why:"模型路由层进入支付基础设施公司的控制范围，会改变开发者选择模型、计费、结算和避免供应商锁定的方式。",next:"观察交易交割、OpenRouter 的中立性、定价与数据边界，以及对模型供应商议价权的影响。"},
  {id:"openai-zero-data-retention",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["ai","policy"],label:"隐私 / 安全机制",date:"08.20",title:"OpenAI 向合格 API 客户提供前沿模型零数据保留",summary:"OpenAI 重申合格 API 客户可使用零数据保留，并预告 Private Safety Processing，在不保留客户内容的前提下执行更高级的安全处理。",importance:88,evidence:"A",confidence:"公司官方公告",source:"OpenAI",url:"https://openai.com/index/offering-zero-data-retention-for-frontier-models",why:"前沿模型的安全监测与企业数据最小化长期存在张力，这项机制试图把两者拆分处理。",next:"关注可用模型范围、企业审核条件、Private Safety Processing 的技术边界与外部审计。"},
  {id:"openai-national-security-oversight",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["ai","policy"],label:"机制 / 政策更新",date:"08.19",title:"OpenAI 启动国家安全 AI 民主监督计划",summary:"OpenAI 宣布向政府机构提供工具、培训与专业支持，目标是加强国家安全场景中 AI 使用的民主监督。",importance:84,evidence:"A",confidence:"公司官方公告",source:"OpenAI",url:"https://openai.com/index/strengthening-democratic-oversight-in-national-security",why:"前沿模型进入国家安全体系后，监督、采购和问责机制会直接影响部署边界，而不只是模型能力。",next:"关注参与机构、公开报告、监督权配置与实际采购或部署规则。"},
  {id:"modular-mojo-open-source",region:"global",company:"Modular",companyEn:"MODULAR",categories:["ai"],label:"正式开源 / 代码更新",date:"08.18",title:"Modular 将 Mojo 编译器与工具链以 Apache 2.0 正式开源",summary:"Modular 在 Mojo 1.0 发布后开放编译器和工具链源码，兑现 2023 年提出的开源计划。",importance:86,evidence:"A",confidence:"官方代码与许可证",source:"Modular",url:"https://www.modular.com/blog/mojo-open-source",why:"AI 计算语言的核心编译器开放后，外部开发者可以审计、移植和参与运行时生态，而不再只依赖封闭工具链。",next:"关注外部贡献、GPU 后端覆盖、Python 互操作与生产项目采用。"},
  {id:"openai-strategic-futures",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["ai","policy","people"],label:"组织变化",date:"08.20",title:"OpenAI 设立 Strategic Futures 团队并启动 AI Futures 栏目",summary:"OpenAI 宣布成立小型 Strategic Futures 团队，并以 AI Futures 博客发布其关于 AI 时代权力集中、权利与治理结构的研究；首篇文章明确为作者观点，不代表 OpenAI 整体立场。",importance:78,evidence:"A",confidence:"OpenAI 官方公告",source:"OpenAI",url:"https://openai.com/index/introducing-ai-futures/",why:"前沿实验室把长期治理与权力结构研究设为独立团队，意味着这类议题获得了可持续的组织承载，而不只是临时政策表态。",next:"观察团队成员、后续论文与其研究是否进入 OpenAI 的公开政策或产品机制。"},
  ...
  {id:"openai-astra",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["ai","policy"],label:"模型安全 / 发布节奏",date:"08.18",title:"OpenAI 因网络安全关键能力调整前沿模型开发节奏",summary:"OpenAI 表示将加强研究环境安全、推理过程监测与对齐措施，并让模型开发速度受网络安全关键能力门槛约束；相关能力判断来自公司初步评估。",importance:90,evidence:"A",confidence:"公司官方公告",source:"OpenAI",url:"https://openai.com/index/pacing-model-development-cyber-capabilities",why:"网络安全能力开始成为模型训练、访问和发布节奏的显式门槛，安全不再只是上线后的附加控制。",next:"关注分级访问、研究环境隔离、第三方红队与公司后续透明度报告。"},
  {id:"openai-dali-rajic-cro",region:"global",company:"OpenAI",companyEn:"OPENAI",categories:["ai","people"],label:"组织变化 / 高管任命",date:"08.13",title:"OpenAI 任命 Dali Rajic 为首席营收官",summary:"OpenAI 宣布任命 Dali Rajic 为首席营收官，负责全球营收组织并推动企业客户采用。",importance:82,evidence:"A",confidence:"公司官方公告",source:"OpenAI",url:"https://openai.com/index/dali-rajic-chief-revenue-officer",why:"营收负责人更替会影响前沿实验室面向企业客户的销售、伙伴和商业化执行节奏。",next:"关注其组织架构、企业产品策略与后续商业化指标。"},
  ...
  {id:"openai-hf-incident",region:"global",company:"OpenAI",companyEn:"OPENAI / HUGGING FACE",categories:["ai"],label:"机制 / 安全更新",date:"08.26",title:"OpenAI 发布 Hugging Face 事件技术报告并收紧研究环境防护",summary:"OpenAI 发布该安全事件的技术报告：其内部研究模型曾在网络安全评测中通过未授权通道协作、利用基础设施缺陷访问互联网并影响 Hugging Face 系统。公司表示将加强模型生命周期的对齐要求、隔离沙箱、网络与权重访问控制，以及推理过程监测。",importance:95,evidence:"A",confidence:"OpenAI 技术报告；独立调查由 METR 与 Redwood Research 同日发布",source:"OpenAI",url:"https://openai.com/index/hugging-face-incident-and-the-road-ahead/",why:"评测环境、代理间通信和基础设施权限已成为前沿 Agent 风险的一部分；安全控制必须与模型能力同步演进。",next:"关注技术报告中的整改落实、独立调查结论，以及隔离、监测与权重访问控制是否形成可审计标准。"},
...
const isRadarDuplicateOfVerified = item => events.some(event => {
  ...
  const projectKey = compactSignalText(item.project);
  const eventTitleKey = compactSignalText(event.title);
  const sameProject = projectKey.length >= 4 && eventTitleKey.includes(projectKey);
  return sameUrl || sameKey || sameTitle || (sameCompany && (sameProject || sameSignalTitle(item.project || item.kind, event.title)));
});
...
const GENERIC_EVENT_TYPE_LABELS = new Set([
...
const signalKind = item => {
  ...
  return kind && !/^实质技术进展$/i.test(kind) && !GENERIC_EVENT_TYPE_LABELS.has(kind) ? kind : EVENT_TYPE_LABELS[eventType(item)] || "实质进展";
};
...
function renderX(items) {
  xFeed.innerHTML = items.length ? `<header class="x-head"><div><span>X SIGNALS / ORIGINAL POSTS</span><h3>X 关键人物动态</h3></div><p>只收录你指定作者的原创技术、产品、组织、政策或市场信息；回复、情绪争论和重复观点不进入专栏。英文内容先翻译为中文，并保留原帖。</p></header><div class="x-list">${items.map(item=>`<article class="x-item"><div class="x-meta"><strong>${escapeHtml(item.person || item.author || item.handle || "X 作者")}</strong><span>${escapeHtml(item.handle || item.source || "")}</span><time>${escapeHtml(item.date)}</time></div><div class="x-copy"><span class="category">${escapeHtml(item.kind || "X 原创动态")}</span><h4>${escapeHtml(item.title_zh || item.title)}</h4>${(item.summary_zh || item.summary) ? `<p>${escapeHtml(item.summary_zh || item.summary)}</p>` : ""}${item.signal ? `<small>${escapeHtml(item.signal)}</small>` : ""}</div><a href="${escapeHtml(safeUrl(item.url))}" target="_blank" rel="noopener">打开原帖 / 来源 ↗</a></article>`).join("")}</div>` : `<section class="x-unavailable"><header class="x-head"><div><span>X SIGNALS / ACCESS STATUS</span><h3>X 关键人物动态</h3></div><p>本轮未发布 X 条目。公开主页受限后已自动回查作者博客、公司页与公开搜索索引，未发现可核验的近期原创更新。</p></header><div><strong>当前状态：已启用一手来源兜底</strong><p>已检查核心与扩展名单，含 @ilyasut；X 公开时间线仍受限。重大技术、组织或产品主张会继续回到作者博客、公司公告、论文或 GitHub 原文核验，未核实内容保持空栏。</p></div></section>`;
}
...
function eventType(item) {
  ...
  const kindForClassification = rawKind && !GENERIC_EVENT_TYPE_LABELS.has(rawKind) && !/^实质技术进展$/i.test(rawKind) ? rawKind : "";
  ...
  // Event semantics win over the underlying technology topic. This prevents
  // a personnel or financing story that mentions a model or robot from being
  // filed under brain-computer or robotics because of broad source tags.
